<template>
  <div class="related-party-config">
    <el-form 
      :model="formData" 
      :disabled="disabled"
      label-width="120px"
      ...
      <el-form-item label="处置方式">
        ...
        <div class="processing-description">
          <p v-if="formData.processingType === 'viewOnly'">
            ...
            该支付命中预警规则时，首页弹出预警信息，提交支取时弹出预警信息
          </p>
...
import type { RelatedPartyWarningConfig, WarningLevel, ProcessingType } from '../../types/warning'

interface Props {
  config: RelatedPartyWarningConfig
  disabled?: boolean
  editMode?: boolean
}

interface Emits {
  (e: 'update', config: RelatedPartyWarningConfig): void
}
...
const emitUpdate = () => {
  const updatedConfig: RelatedPartyWarningConfig = {
    ...props.config,
